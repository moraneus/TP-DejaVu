...
class Test42 extends TestCase {
  ...
  @Test def test3(): Unit = {
    Verify("--execution", "0", "--specfile", spec, "--logfile", biglog10k, "--resultfile", resultfile)
  ...
  // @Test
  def test4(): Unit = {
    Verify("--execution", "0", "--specfile", spec, "--logfile", biglog20k, "--resultfile", resultfile)
  ...
  // @Test
  def test5(): Unit = {
    Verify("--execution", "0", "--specfile", spec, "--logfile", biglog40k, "--resultfile", resultfile)
