...
class Test18 extends TestCase {
  ...
  @Test def test5_1(): Unit = {
    Verify("--execution", "0", "--specfile", spec5, "--logfile", log1, "--resultfile", resultfile, "--bits", "3")
  ...
  @Test def test1_2_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log2, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 2052002)
  }

  @Test def test1_2_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log2, "--resultfile", resultfile, "--bits", "20")
  ...
  @Test def test2_2_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log2, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2052002, 998998 gc)
  }

  @Test def test2_2_15(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log2, "--resultfile", resultfile, "--bits", "16")
  ...
  @Test def test3_2_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log2, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 2052003)
  }

  @Test def test3_2_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log2, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2047575 oom)
  }
  ...
  @Test def test4_2_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log2, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2052003,998998 gc)
  }

  @Test def test4_2_16(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log2, "--resultfile", resultfile, "--bits", "16")
  ...
  @Test def test1_3_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log3, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 3007002)
  }

  @Test def test1_3_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log3, "--resultfile", resultfile, "--bits", "20")
  ...
  @Test def test2_3_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log3, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 3007002)
  }

  @Test def test2_3_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log3, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 3007002,1047591 gc)
  }

  @Test def test2_3_10(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log3, "--resultfile", resultfile, "--bits", "10")
  ...
  @Test def test3_3_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log3, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 3007003)
  }

  @Test def test3_3_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log3, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2096168 oom)
  }
  ...
  @Test def test4_3_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log3, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 3007003,1047591 gc)
  }

  @Test def test4_3_10(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log3, "--resultfile", resultfile, "--bits", "10")
  ...
  @Test def test1_4_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log4, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 2400008)
  }

  @Test def test1_4_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log4, "--resultfile", resultfile, "--bits", "20")
  ...
  @Test def test2_4_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log4, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 2400008)
  }

  @Test def test2_4_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log4, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2400008,1048572 gc)
  }

  @Test def test2_4_10(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log4, "--resultfile", resultfile, "--bits", "10")
    checkResultsBrief(resultfile, 2400008,1199520 gc)
  }

  @Test def test2_4_3(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log4, "--resultfile", resultfile, "--bits", "3")
  ...
  @Test def test3_4_21(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log4, "--resultfile", resultfile, "--bits", "21")
    checkResultsBrief(resultfile, 2400009)
  }

  @Test def test3_4_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log4, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2097149 oom)
  }
  ...
  @Test def test4_4_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log4, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2400009,1048572 gc)
  }

  @Test def test4_4_10(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log4, "--resultfile", resultfile, "--bits", "10")
    checkResultsBrief(resultfile, 2400009,1199520 gc)
  }

  @Test def test4_4_3(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log4, "--resultfile", resultfile, "--bits", "3")
  ...
  @Test def test1_5_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec1, "--logfile", log5, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2000002)
  }

  @Test def test1_5_2(): Unit = {
    Verify("--execution", "0", "--specfile", spec1, "--logfile", log5, "--resultfile", resultfile, "--bits", "2")
  ...
  @Test def test2_5_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log5, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2000002)
  }

  @Test def test2_5_2(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec2, "--logfile", log5, "--resultfile", resultfile, "--bits", "2")
  ...
  @Test def test3_5_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec3, "--logfile", log5, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2000004)
  }

  @Test def test3_5_2(): Unit = {
    Verify("--execution", "0", "--specfile", spec3, "--logfile", log5, "--resultfile", resultfile, "--bits", "2")
    checkResultsBrief(resultfile, 8 oom)
  }
  ...
  @Test def test4_5_20(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log5, "--resultfile", resultfile, "--bits", "20")
    checkResultsBrief(resultfile, 2000004)
  }

  @Test def test4_5_2(): Unit = {
    Verify.long("--execution", "0", "--specfile", spec4, "--logfile", log5, "--resultfile", resultfile, "--bits", "2")
